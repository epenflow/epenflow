...
export const Maximize: React.FC<Icons> = ({ className, ...rest }) => {
	return (
		<svg suppressHydrationWarning {...{ ...rest, ...ICON_STYLE }}>
...
export const Arrow: React.FC<Icons> = ({ ...rest }) => {
	return (
		<svg {...rest}>
			<defs>
			...
			<path
				d="M431 273.6l212.9 212.9c14.1 14.1 14.1 36.9 0 50.9L431 750.4c-22.7 22.7-61.5 6.6-61.5-25.5V299.1c0-32.1 38.8-48.1 61.5-25.5z"
				p-id="6780"
				fill="#2c2c2c"></path>
		</svg>
	);
