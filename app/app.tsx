...
import { ReorderAble } from '@/components/reaorder-able';
	...
	return (
		<React.Fragment>
			...
			<main className="relative w-screen overflow-x-hidden">
				...
				<ReorderAble label="notes" initialId={2} initialZIndex={50}>
					{/* <Notes /> */}
					<Drag />
				</ReorderAble>
				<ReorderAble label="project" initialId={3} initialZIndex={50}>
